...
const TemukanBukuFavoritmu = () => {
  const navigation = useNavigation();

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Image
        source={require("../assets/images/temukanbukufavoritmu.jpg")}
        style={styles.image}
        resizeMode="contain"
      />

      <Text style={styles.title}>Temukan Buku Favoritmu</Text>

      <Text style={styles.description}>
        Ribuan buku seru siap kamu pinjam langsung dari perpustakaan. Semua ada
        di genggaman lewat Nusapedia!
      </Text>
...
export default TemukanBukuFavoritmu;